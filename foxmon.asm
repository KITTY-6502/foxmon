#  - A simple monitor operating system for the KITTY -
#  the monitor boots from rom and proceeds to copy itself to RAM at [$1000]
#
.cpu 65c02
...
_serialcheck
    ...
    lda <cur_bank>; sta [$70D0]

# Main LOOP
_irq
# Automatic Serial Logic
__serial
lda <serial_active>; beq (noserial)
    lda $40; sta [$70D0]
    lda [$8005]
    cmp 1; bne (noserial)
    # Automatic Serial Logic goes here!
    # ....
    # ....
___noserial
lda <cur_bank>; sta [$70D0]
...
_Run
    ...
    lda <$82>; cmp $F2; beq (pokej); jsr [TextToHex]; bmi (BAD)
    asl A; asl A; asl A; asl A
    sta <$08>
...
rts
    ...
    __poke
        ...
        lda <$80>; jsr [TextToHex]; bmi (BADj)
        asl A; asl A; asl A; asl A
        sta <$09>
        lda <$81>; jsr [TextToHex]; bmi (BADj)
        ora <$09>; sta <$09>
        
        lda <$82>; jsr [TextToHex]; bmi (BADj)
        asl A; asl A; asl A; asl A
        sta <$08>
        lda <$83>; jsr [TextToHex]; bmi (BADj)
        ora <$08>; sta <$08>
        
        # copy value to the destination
        lda <$10>; sta [<$08>]
        
        # check if BANK was written to and update <cur_bank> accordingly
        lda $70; cmp <$09>; bne (nobank)
        lda $D0; cmp <$08>; bne (nobank)
        lda <$10>; sta <cur_bank>
    ___nobank
    rts
    ___BADj
